                    ...
                    [
                      _c(
                        "a",
                        {
                          ...
                          attrs: {
                            class: "nav-link py-1",
                            href: "#debugging-with-visual-studio-code-vs-code",
                          },
                        },
                        ...
                        [
                          _c(
                            "a",
                            {
                              ...
                              attrs: {
                                class: "nav-link py-1",
                                href: "#setting-up-debugger-in-vs-code",
                              },
                            },
                          ...
                          _c(
                            "a",
                            {
                              ...
                              attrs: {
                                class: "nav-link py-1",
                                href: "#advanced-debugging-features",
                              },
                            },
...
var pageVueStaticRenderFns = [
  function anonymous() {
    with (this) {
      return _c(
        "h1",
        { attrs: { id: "debugging-with-visual-studio-code-vs-code" } },
        [
          _v("Debugging with Visual Studio Code (VS Code)"),
          _c("a", {
      ...
      return _c("ol", [
        _c("li", [
          _c("p", [
            ...
            _c("a", { attrs: { href: "https://code.visualstudio.com/" } }, [
              _v("https://code.visualstudio.com/"),
            ]),
            _v(")."),
          ]),
        ]),
  ...
  function anonymous() {
    with (this) {
      return _c("h2", { attrs: { id: "conclusion" } }, [
        ...
        _c("a", {
          staticClass: "fa fa-anchor",
          attrs: { href: "#conclusion", onclick: "event.stopPropagation()" },
        }),
      ]);
    }
  },
  function anonymous() {
    with (this) {
      return _c("p", [
        _v(
          "For detailed information on debugging in Visual Studio Code, refer to the official ",
        ),
        _c(
          "a",
          {
